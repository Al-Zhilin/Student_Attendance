...
//--------------------------------------ОФФСЕТЫ--------------------------------------------------------------------------------------------------------------------------------------------------------------
byte offset = 24;                                                                                //смещение (в количестве строк) между одними и теми же данными, в неделях, различающийся по номеру на 1
...
#define Sheet1 "People!"                                                                         //имя листа с данными
