...
#define COUNT_COLUMN_OFFSET 5                                                                    //количество столбцов отступа от самой длинной недели до столбца, в котором будут размещаться итоговые цифры подсчета
...
//--------------------------------------ОФФСЕТЫ--------------------------------------------------------------------------------------------------------------------------------------------------------------
byte offset[] = {24, 24};                                                                        //смещение (в количестве строк) между одними и теми же данными, в неделях, различающийся по номеру на 1, для каждого листа (подгруппы)
