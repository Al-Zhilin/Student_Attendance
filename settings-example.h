...
//--------------------------------------ОФФСЕТЫ--------------------------------------------------------------------------------------------------------------------------------------------------------------
byte offset[] = {24, 24};                                                                        //смещение (в количестве строк) между одними и теми же данными, в неделях, различающийся по номеру на 1, для первого и втоорого соответственно листа (подгруппы)
